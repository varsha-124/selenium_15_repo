...
public class DownloadInvoiceAfterPurchaseOrder {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		String currentUrl1 = driver.getCurrentUrl(); //capture the current url

		if(currentUrl1.contains("login")) {//login page verification
		...
		System.out.println("Logged in as  "+juhi);
